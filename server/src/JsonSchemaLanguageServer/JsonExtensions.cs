...
namespace Rosser.Extensions.JsonSchemaLanguageServer
{
    ...
    public static class JsonExtensions
    {
        ...
        {
            element.TryGetPropertyValue("$schema", out string? value);
            return value;
        }

        public static string? GetDocumentId(this JsonElement element)
        {
            element.TryGetPropertyValue("$id", out string? value);
            return value;
        }
        ...
        {
            if (!element.TryGetProperty("id", out JsonElement idValue))
            {
