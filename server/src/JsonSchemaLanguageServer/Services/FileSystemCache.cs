// <copyright file="FileSystemSchemaCache.cs">Copyright (c) Peter Rosser.</copyright>
...
namespace Rosser.Extensions.JsonSchemaLanguageServer.Services
{
    ...
    {
        private Dictionary<string, (string path, DateTime lastWriteTime, byte[] content)> cache = new(StringComparer.OrdinalIgnoreCase);
